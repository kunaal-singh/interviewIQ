...
// ============ SKILLS BOX ============
    ...
    if (finalScore >= 8) {
      advice =
        "Excellent performance. Maintain confidence and structure. Continue " +
        "refining clarity and supporting answers with strong real-world examples.";
    } else if (finalScore >= 5) {
      advice =
        "Good foundation shown. Improve clarity and structure. Practice " +
        "delivering concise, confident answers with stronger supporting examples.";
    } else {
        advice =
    "Significant improvement required. Focus on structured thinking, " +
    ...
    return (
        ...
        px-4 sm:px-6 lg:px-10 py-8'>
            <div className='mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
                ...
                py-3 rounded-xl shadow-md transiton-all duration-300 font-semibold
                            ...
                            skills.map((s,i)=>(
                               <div key={i}>
                                   <div className='flex justify-between mb-3 text-sm sm:text-base'>
                                    ...
                                    <span>{s.label}</span>
                                    <span className='font-semifold text-green-600'>{s.value}</span>
                                   </div>
